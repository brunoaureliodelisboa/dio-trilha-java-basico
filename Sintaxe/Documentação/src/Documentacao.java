package Sintaxe.Documentação.src;
...
* @since   01/01/2022
*/
public class Documentacao1 {
    /**
   * Este método é utilizado para somar dois números inteiros
   * @param numeroUm1 este é o primeiro parâmetro do método
   * @param numeroDois1 este é o segundo parâmetro do método
   * @return int o resultado deste método é a soma dos dois números.
   */
    public int somar(int numeroUm1, int numeroDois1) {
        return  numeroUm1 + numeroDois1;
    }
}
```
